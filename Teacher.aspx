<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teacher.aspx.cs" Inherits="WebApplication3.WebForm3" %>
...
<body>
    ...
    <div>
    <center>
        <asp:Label ID="Label7" runat="server" Text="Teacher Details" Height="34px" 
    ...
    <td  >
        <asp:Label ID="Label1" runat="server" Text=" Name" Width="84px" 
            Height="19px"></asp:Label>
      
    </td>
    &nbsp;&nbsp;
    <td >
        <asp:TextBox ID="Txtnm" runat="server" Width="584px" Height="34" 
    ...
    <td  >
        <asp:Label ID="Label2" runat="server" Text="Subject" Width="84px"></asp:Label>
       
    </td>
    &nbsp;&nbsp;
    <td >
        <asp:TextBox ID="Txtsub" runat="server" Width="584px" Height="34"></asp:TextBox>
    </td>
    </tr>
    ...
    &nbsp;&nbsp;
    <td >
        <asp:TextBox ID="Txtmo" runat="server" Width="584px" Height="34"></asp:TextBox>
    </td>
    </tr>
